...
print("Running as Username: ", DATABASE)
...
#df = df.withColumn("monthlycharges", df["monthlycåharges"].cast(DoubleType()))
...
df=df.withColumn('monthlycharges', regexp_replace('monthlycharges', r'[.]', ','))
